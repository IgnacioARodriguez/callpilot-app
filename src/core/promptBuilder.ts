...
export const buildPromptWithEvidence = (context: GlobalContext, userInput: string, evidence: EvidenceSelection): BuiltPrompt => {
  ...
  const system = [
    ...
    "For interview modes, write like a candidate answer to say aloud: direct first sentence, no greeting, no decorative markdown, no all-caps headings, and no code block unless the interviewer explicitly asks for code.",

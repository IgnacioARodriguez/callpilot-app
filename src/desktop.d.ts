...
declare global {
  ...
  interface Window {
    ...
    callpilotDesktop?: {
      ...
      requestAnswer: (input?: string | { questionOverride?: string; audience?: "chat" | "coding" | "both" }) => Promise<{ ok: boolean; error?: string; requestId?: string }>;
      ...
      onManualAnswerRequest: (callback: (payload?: { questionOverride?: string; audience?: "chat" | "coding" | "both" }) => void) => () => void;

...
const requiredSourceChecks = [
  ...
  ["electron/main.cjs", "const sessionPassthroughEnabled = Boolean(stealthState.mousePassthroughEnabled && activeSessionTrace)"],
  ["electron/main.cjs", "setIgnoreMouseEvents(windowRef !== mainWindow && sessionPassthroughEnabled"],
